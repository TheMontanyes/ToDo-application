<template>
  <div class="group">
    <div class="group-item" @click="showModal = !showModal">
    ...
    <transition name="fade">
      <div :class="{'overlay': showModal}" v-if="showModal">
        <div class="modal">
            ...
            <select class="select" v-model.trim="filterStatus">
            ...
            <transition name="fade">
              <div class="overlay" v-if="showDialog">
                <div class="modal modal-dialog">
                  ...
                  <div class="btn-group justify">
                    <button class="btn" @click="$emit('delete-card', index), showModal = false, showDialog = false">Да</button>
